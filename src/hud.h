// Bart Middag & Thomas Dhondt ; groepsnummer: 14 ; hud.h
...
typedef enum {BUTTON_TOWER_MACHINEGUN, BUTTON_TOWER_ROCKET, BUTTON_TOWER_FLAK, BUTTON_DESTROY_TOWER, BUTTON_SPELL_FREEZE, BUTTON_SPELL_KILL} ButtonType;
